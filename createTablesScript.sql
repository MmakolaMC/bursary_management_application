...
BEGIN
    CREATE TABLE [dbo].[Department](
        ...
        [InstitutionID] [int] REFERENCES [dbo].[Institution]([InstitutionID])
    )
END;
...
BEGIN
    CREATE TABLE [dbo].[Student](
        ...
        [StudentAge] [int] NULL,
        [YearOfStudy] [int] DEFAULT YEAR(GETDATE()),   
        [ProgramID] [int] REFERENCES [dbo].[Program]([ProgramID]),
        [RaceID] [int] REFERENCES [dbo].[Race]([RaceID])
    )
END;
...
BEGIN
    CREATE TABLE [dbo].[Budget](
        ...
        [ReviewerID] [int] REFERENCES [dbo].[Reviewer]([ReviewerID])
    )
END;
...
BEGIN
    CREATE TABLE [dbo].[Application](
        ...
        [ApplicationStatus] [varchar](120) NULL,
        [DepartmentID] [int] REFERENCES [dbo].[Department]([DepartmentID]),
        [StudentID] [int] REFERENCES [dbo].[Student]([StudentID]),
...
BEGIN
    CREATE TABLE [dbo].[Funds](
        ...
        [DepartmentID] [int] REFERENCES [dbo].[Department]([DepartmentID]),
        [BudgetID] [int] REFERENCES [dbo].[Budget]([BudgetID])
    )
END;
